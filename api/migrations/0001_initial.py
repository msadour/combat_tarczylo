    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.CharField(blank=True, max_length=255)),
                ('date_creation', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 26, 20, 47, 7, 567592, tzinfo=utc), null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Member',
            fields=[
                ...
                ('date_creation', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 26, 20, 47, 7, 569571, tzinfo=utc), null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, max_length=255)),
                ('date_creation', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 26, 20, 47, 7, 573369, tzinfo=utc), null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Presentation',
